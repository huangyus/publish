<template>
  <div>
    <el-row :gutter="20" style="margin-bottom: 15px;">
      <el-col :span="1.5">
        <el-button v-permission="['add_businesstemplate']" type="primary" icon="el-icon-edit" @click="handleCreate">新建模版</el-button>
      </el-col>
      <el-col :span="6">
      ...
      <el-row type="flex" justify="center">
        <el-form ref="dataForm" :model="form" :rules="rules">
          ...
          <el-form-item v-if="form.idc.length > 0" :label-width="formLabelWidth" label="服务器分组">
            <el-col :span="20">
              <el-select v-model="form.servers" placeholder="请选择服务器分组" filterable multiple style="width: 100%" @visible-change="groupfetchData(form.idc)">
...
import { createTemplate, updateTemplate } from '@/api/bstemplate'
import { filterVersion } from '@/api/business'
  ...
  data() {
    return {
      ...
      rules: {
        ...
        periodic: [{ required: true, message: '定时任务时间必填', trigger: 'change' }],
